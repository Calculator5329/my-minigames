NDP.registerManifest({
  ...
  assets: (() => {
    ...
    return [
      ...
      { key: 'orb_turret_dart_paragon',     src: sp.turret_dart,    type: 'image' },
      { key: 'orb_turret_cannon_paragon',   src: sp.turret_cannon,  type: 'image' },
      { key: 'orb_turret_beam_paragon',     src: sp.turret_beam,    type: 'image' },
      { key: 'orb_turret_gravity_paragon',  src: sp.turret_gravity, type: 'image' },
      { key: 'orb_turret_missile_paragon',  src: sp.turret_missile, type: 'image' },
      { key: 'orb_turret_sniper_paragon',   src: sp.turret_sniper,  type: 'image' },
      ...
      { key: 'orb_turret_saboteur', src: sp.turret_saboteur, type: 'image' },
